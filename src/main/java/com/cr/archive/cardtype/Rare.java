...
public class Rare {
    ...
    private int number;
    private int gross = 2586;
    private int currentGross;
    private int remainGross;
    private int totalGold = 185600;
    private int currentGold;
    private int remainGold;
    private int totalExp = 3791;
    private int currentExp;
    private int remainExp;
    private static int[] upgradeNumber = {0, 2, 4, 10, 20, 50, 100, 200, 400 ,800, 1000};
    private static int[] upgradeGold = {0, 50, 150, 400, 1000, 2000, 4000, 8000, 20000, 50000, 100000};
    private static int[] upgradeExp = {0, 6, 10, 25, 50, 100, 200, 400, 600, 800, 1600};
    ...
    public Rare(int level, int number) {
        this.level = level;
        this.number = number;
        calculate();
    }

    public Rare(String name, int level, int number, String imgUrl) {
        this.name = name;
        this.level = level;
        this.number = number;
        this.imgUrl = imgUrl;
